                    ...
                    <div className="flex">
                        ...
                        <div className="w50">
                            ...
                            <div className="mTop30 flex gap30">
                                <Link href="/" className={styles.Link}>ademe.fr<span className="material-icons">open_in_new</span></Link>
                                <Link href="/" className={styles.Link}>beta.gouv.fr<span className="material-icons">open_in_new</span></Link>
                            </div>
                        </div>
                    </div>
