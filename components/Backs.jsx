...
export default function Reviews({ session, setOpen }) {
    ...
    const questionLabels = {
        ...
        "2": "Etablir ou renforcer des collaborations avec d’autres participants ?",
        "3": "Utilité pour vos missions au sein de votre collectivité ?",
            ...
            <div className={styles.Reviews}>
                ...
                <div className="flex aligncenter space-between w100 gap40 mTop30">
                    <span className={`${styles.Title} w60`}>
                        ...
                        Retours sur la session du {formatDate(session.dateDebut)}, {session.region}
                    </span>
                </div>
                <div className="mTop30">
                    <h3 className="mTop20">Retours sur la rencontre :</h3>
                    {quizz.length > 0 ? (
                        <>
                        ...
                        <span className="block mTop20">Aucun retour.</span>
                    )}
                </div>
            </div>
        </>
